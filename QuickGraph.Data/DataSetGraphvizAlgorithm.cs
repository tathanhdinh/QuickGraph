...
namespace QuickGraph.Data
{
  ...
  {
    public DataSetGraphvizAlgorithm(DataSetGraph visitedGraph) : base(visitedGraph)
    {
      this.InitializeFormat();
    }

    public DataSetGraphvizAlgorithm(DataSetGraph visitedGraph, string path, GraphvizImageType imageType) : base(visitedGraph, path, imageType)
    {
      this.InitializeFormat();
    }
    ...
    private void InitializeFormat()
    {
      ...
      this.CommonVertexFormat.Style.Add(GraphvizVertexStyle.Solid);
