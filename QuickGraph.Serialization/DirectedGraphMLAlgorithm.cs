...
{
  public sealed class DirectedGraphMLAlgorithm<TVertex, TEdge> : AlgorithmBase<IVertexAndEdgeListGraph<TVertex,TEdge>> where TEdge : IEdge<TVertex>
  {
    readonly VertexIdentity<TVertex> vertexIdentities;
    readonly EdgeIdentity<TVertex, TEdge> edgeIdentities;
    DirectedGraph directedGraph;

    public DirectedGraphMLAlgorithm(IVertexAndEdgeListGraph<TVertex, TEdge> visitedGraph, 
                                    VertexIdentity<TVertex> vertexIdentities, 
                                    EdgeIdentity<TVertex, TEdge> edgeIdentities) : base(visitedGraph)
    {
    ...
    public DirectedGraph DirectedGraph
    {
      ...
      private void OnFormatGraph()
      {
        ...
        this.FormatGraph?.Invoke(this.VisitedGraph, this.DirectedGraph);
      }
      ...
      //if (eh != null)
      //    eh(edge, link);
        this.FormatEdge?.Invoke(edge, link);
      }
