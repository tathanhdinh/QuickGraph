...
{
  public abstract class GraphRendererBase<TVertex,TEdge> where TEdge : IEdge<TVertex>
  {
    ...
    protected virtual void Initialize()        
    {
      ...
      //this.graphviz.CommonVertexFormat.Style = new System.Collections.Generic.HashSet<GraphvizVertexStyle>(GraphvizVertexStyle.Filled);
      this.graphviz.CommonVertexFormat.Style.Add(GraphvizVertexStyle.Filled);
