namespace QuickGraph.Graphviz.Dot
{
  ...
  public class GraphvizVertex
  {
    ...
    //private List<GraphvizVertexStyle> style = new List<GraphvizVertexStyle>();
    private HashSet<GraphvizVertexStyle> style = new HashSet<GraphvizVertexStyle>();
    ...
    public HashSet<GraphvizVertexStyle> Style
    {
      get
      {
        return this.style;
      ...
      set
      {
        //if (value.Contains(GraphvizVertexStyle.Unspecified)) 
        this.style = value;
